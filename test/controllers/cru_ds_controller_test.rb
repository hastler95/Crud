...
class CruDsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crud" do
    assert_difference('Crud.count') do
      post cruds_url, params: { crud: { content: @crud.content, date: @crud.date, title: @crud.title } }
    end
  ...
  test "should update crud" do
    patch crud_url(@crud), params: { crud: { content: @crud.content, date: @crud.date, title: @crud.title } }
